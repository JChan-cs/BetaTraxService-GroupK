...
admin.site.register(Defect Report)
...
fieldsets = (("Product Info", {"fields": ("ProductID", "Version", "ReportTitle", "Description", "Steps", "Status", "Severity", "Priority")}),("Tester Info", {"fields": ("TesterID", "Email")}),("Time", {"fields": ("CreatedTime", "UpdatedTime")}),)
